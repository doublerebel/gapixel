...
(function() {
  ...
  GAPixel = (function() {
    ...
    GAPixel.prototype.trackPageView = function() {
      ...
      domainName = this.req.headers["host"] || "";
      ...
      utmUrl = UTM_GIF_LOCATION + "?" + "utmwv=" + VERSION + "&utmn=" + Utils.getRandomNumber() + "&utmhn=" + domainName + "&utmr=" + documentReferer + "&utmp=" + documentPath + "&utmac=" + account + "&utmcc=__utma%3D999+999+999+999+999+1%3B" + "&utmvid=" + visitorId + "&utmip=" + this.getIP(this.req.connection.remoteAddress);
